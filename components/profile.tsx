...
const Profile = (props: any) => {
    ...
    return (
        <main className="sm:relative flex h-full w-full sm:flex-col min-w-[370px] max-h-[352px] border-4 bg-gradient-to-br from-black via-blue-400/75 to-black">

            <div className={`hidden sm:flex w-full max-w-screen-2xl flex-1 bg-sky-800 h-1/8 ${props.name ? "order-1" : "order-3"} sm:order-1 border-4`}> </div>
            <div className="flex flex-col my-2 justify-center items-center w-full order-2 gap-3 text-lg sm:h-2/3 sm:min-h-[220px] sm:p-4  max-[640px]:flex-1 max-sm:border-l-4 border-4 border-green-400">
